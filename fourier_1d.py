"""
@author: Zongyi Li
This file is the Fourier Neural Operator for 1D problem such as the (time-independent)
...
def get_data(
    ...
    dataloader = MatReader('PDE_datasets/burgers_data_R10.mat')
...
def train(
    ...
    print(f'Epoch\t Time\t train_mse\t train_l2\t test_l2')
    for ep in range(epochs):
        ...
        t2 = default_timer()
        print(f'{ep}\t {round(t2-t1,2)}\t {round(train_mse,7)}\t {round(train_l2,7)}\t{round(test_l2,7)}')
