...
def get_model(modes, width, learning_rate, scheduler_step, scheduler_gamma):
...
def train(model, optimizer, scheduler, y_normalizer, train_loader, test_loader, epochs, batch_size, S, T,
            ntrain, ntest):
    myloss = LpLoss(size_average=False)
    #vj y_normalizer.cuda()
...
def test(model, test_a, test_u, y_normalizer, myloss):
